...
class CalendarEvent(Base):
    ...
    Sourced two different ways, tracked via `source`:
      ...
      - "llm_generated" — sports/music events (added 2026-09-16, no free API
        covers either comprehensively): periodically regenerated by
        generate_sports_and_music_events(), scoped to high-confidence,
        calendar-fixed recurring events only (see that function's prompt).
    ...
    category = Column(String(20), nullable=False, index=True)  # holiday | religious | political | sports | music
