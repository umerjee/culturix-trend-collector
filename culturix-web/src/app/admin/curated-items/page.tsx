...
export default function CuratedItemsPage() {
  ...
  return <div className="max-w-6xl">
    <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
      <div><div className="flex items-center gap-2 text-primary-600 text-xs font-bold uppercase tracking-wider"><Database className="h-4 w-4" /> Source library</div><h1 className="mt-2 text-2xl font-bold text-gray-900">Curated content candidates</h1><p className="mt-1 text-sm text-gray-500">Fetch real source material, review the scoring, then select what should become content.</p></div>
