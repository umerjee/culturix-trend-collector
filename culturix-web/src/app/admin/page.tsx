...
export default async function AdminPage() {
  ...
  const [trendsRes, clustersRes, personasRes, digestsRes] = await Promise.allSettled([
  ...
  return <AdminDashboard trends={trends} clusters={clusters} personas={personas} digests={digests} apiUrl={apiUrl} />;
}
