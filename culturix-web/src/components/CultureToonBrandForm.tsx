...
export default function CultureToonBrandForm() {
  ...
  async function create(e: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      await fetch("/api/culturetoons/brand", {
        method: "POST",
  ...
  return (
    <div className="rounded-2xl border-2 border-dashed border-gray-200 py-16 px-6 text-center">
      ...
      <h3 className="font-semibold text-gray-700 mb-2">Create your CultureToons brand</h3>
      <p className="text-sm text-gray-400 max-w-sm mx-auto mb-5">
        Set up your character brand — you&apos;ll build base characters, cultural variants,
        expressions, backgrounds, and skit scripts inside it.
      </p>
