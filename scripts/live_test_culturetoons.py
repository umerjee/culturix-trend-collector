...
need a real KLING_API_KEY credential available in this local environment
(see the plan's flagged open question: one live Kling Omni call is needed
to confirm the native-audio-speaks-dialogue hypothesis before relying on
it). This script covers everything that doesn't depend on that: multi-brand
...
def main():
    ...
    logger.info("SMOKE TEST PASSED (register-element / generate-video NOT covered — need a real KLING_API_KEY)")
